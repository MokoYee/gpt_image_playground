...
export default function DetailModal() {
  ...
  const isFavoriteRoute = location.pathname.startsWith('/favorites') || location.pathname.startsWith('/favorite')
    ...
    >
      ...
      >
        ...
        <div className="md:w-1/2 w-full p-5 overflow-y-auto overscroll-contain flex flex-col">
          ...
          {/* 操作按钮 */}
          <div className={`grid ${isFavoriteRoute ? 'grid-cols-2' : 'grid-cols-4'} sm:flex gap-2 pt-4 border-t border-gray-100 dark:border-white/[0.08]`}>
            {!isFavoriteRoute && (
              <>
                <button
                  onClick={handleReuse}
            ...
            <button
              ...
              className={`${isFavoriteRoute ? 'col-span-1' : 'col-span-3'} sm:flex-1 flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl bg-red-50 dark:bg-red-500/10 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-500/20 transition text-sm font-medium whitespace-nowrap`}
            >
