            ...
            {activeTab === 'about' && (
              <div className="flex h-full min-h-[300px] flex-col items-center justify-center pb-8 px-6">
                <div className="flex flex-col items-center">
                  <div className="mb-5 flex h-[88px] w-[88px] items-center justify-center rounded-full border border-gray-200/80 bg-gray-50/50 text-gray-500 dark:border-white/[0.08] dark:bg-white/[0.02] dark:text-gray-300">
                    <svg className="h-11 w-11" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <rect x="3" y="4" width="18" height="16" rx="3" strokeWidth="1.5" />
                      <circle cx="9" cy="10" r="2" strokeWidth="1.5" />
                      <path d="m5.5 18 4.2-4.2a1.5 1.5 0 0 1 2.1 0l1.2 1.2 1.8-1.8a1.5 1.5 0 0 1 2.1 0l2.6 2.6" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
                    </svg>
                  </div>
